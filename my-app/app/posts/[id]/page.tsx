    ...
    <div className="max-w-2xl mx-auto pb-24">
      ...
      <div className="p-4 md:p-6">
        ...
        <div className="flex items-center justify-between py-4 border-t border-b border-gray-100 mb-6">
          ...
          <button
            onClick={toggleVote}
            className={`flex items-center gap-2 px-4 py-2 rounded-2xl font-bold text-sm transition ${
              voted ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
            }`}
          >
        ...
        {comments.length === 0 && (
          <p className="text-gray-400 text-sm text-center py-6">Пока нет комментариев. Будьте первым!</p>
        )}
          ...
          <div className="flex gap-3 items-end">
            ...
            <div className="flex-1 flex gap-2">
              <textarea
                ...
                rows={1}
                className="flex-1 bg-gray-50 border border-gray-200 rounded-2xl px-4 py-3 text-sm outline-none focus:border-blue-500 resize-none transition"
                onKeyDown={(e) => {
              ...
              <button
                ...
                className="p-3 bg-blue-600 text-white rounded-2xl hover:bg-blue-700 disabled:opacity-40 transition shrink-0"
              >
                <Send size={18} />
              </button>
            </div>
